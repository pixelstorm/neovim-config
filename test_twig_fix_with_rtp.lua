-- Test script to validate Twig syntax highlighting fix with proper runtime path
-- Run this with: nvim --headless -l test_twig_fix_with_rtp.lua

-- Set up runtime path to include current directory
...
print("=== TWIG SYNTAX HIGHLIGHTING FIX TEST (WITH RTP) ===")
print("File: " .. temp_file)
print("Runtime path includes: " .. vim.fn.getcwd())
